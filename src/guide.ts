...
const KEYS: readonly (readonly [string, string])[] = [
  ...
  ['Guard', `Hold the right mouse button, or ${GUARD_KEY} — sword only`],
...
const TOUCH: readonly (readonly [string, string])[] = [
  ...
  ['Guard / parry', 'Hold the blue shield button above attack; tap it as the blow lands to parry. Sword only'],
